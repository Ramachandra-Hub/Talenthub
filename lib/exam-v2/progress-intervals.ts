...
export const EXAM_SERVER_PROGRESS_INTERVAL_MS = 12_000;

/** ElevateX placement take — faster heartbeat so admin live board updates during the exam. */
export const ELEVATEX_SERVER_PROGRESS_INTERVAL_MS = 10_000;
