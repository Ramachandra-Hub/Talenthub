...
export function PortalSidebar({ open = false, onClose }: Props) {
  ...
  return (
    <>
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto px-2.5 pb-3 space-y-1" aria-label="Student portal">
          {PORTAL_NAV.map((item) => {
        ...
        <div className="m-3 overflow-hidden rounded-lg border border-cyan-500/20 ex-panel p-0">
          <div
